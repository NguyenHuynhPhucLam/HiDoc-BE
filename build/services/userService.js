...
var handleUserLogin = function handleUserLogin(userEmail, userPassword) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            userData = {};
            _context2.next = 4;
            return checkUserEmail(userEmail);
          case 4:
            ...
            return _index["default"].User.findOne({
              ...
              attributes: ['id', 'email', 'roleId', 'password', 'firstName', 'lastName', 'birthday'],
              raw: true
            });
          case 8:
            user = _context2.sent;
            ...
            _context2.next = 12;
            return _bcryptjs["default"].compareSync(userPassword, user.password);
          case 12:
