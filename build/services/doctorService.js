...
var saveInfoDoctorService = function saveInfoDoctorService(inputData) {
  return new Promise( /*#__PURE__*/function () {
...
var getDoctorDetailByIdService = function getDoctorDetailByIdService(inputId) {
  return new Promise( /*#__PURE__*/function () {
...
var bulkCreateScheduleService = function bulkCreateScheduleService(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
      var schedules, existing, toCreate;
...
var getExtraInfoDoctorByIdService = function getExtraInfoDoctorByIdService(inputId) {
  return new Promise( /*#__PURE__*/function () {
...
var getProfileDoctorByIdService = function getProfileDoctorByIdService(inputId) {
  return new Promise( /*#__PURE__*/function () {
          ...
          case 5:
            ...
            return _index["default"].Booking.findAll({
              ...
              include: [{
                model: _index["default"].User,
                as: 'patientData',
                attributes: ['email', 'firstName', 'address', 'gender', 'birthday', 'phoneNumber'],
                include: [{
                  model: _index["default"].Allcode,
                  as: 'genderData',
                  attributes: ['valueEn', 'valueVi']
...
var postSavePatientInfo = function postSavePatientInfo(inputData) {
  return new Promise( /*#__PURE__*/function () {
    var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 5:
            _context10.next = 7;
            return _index["default"].Patient_Info.findOrCreate({
              where: {
...
var getPatientInfoByPId = function getPatientInfoByPId(inputId) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          case 0:
            _context11.prev = 0;
            _context11.next = 3;
            return _index["default"].Patient_Info.findOne({
              where: {
                patientId: inputId
              },
...
var deleteMedicalReportByPatientId = /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(userId, medicineId) {
              ...
              return _regeneratorRuntime().wrap(function _callee12$(_context12) {
                while (1) switch (_context12.prev = _context12.next) {
                  case 0:
                    _context12.prev = 0;
                    _context12.next = 3;
                    return _index["default"].Medical_Report.findOne({
                      where: {
                        patientId: userId,
...
var deleteBookingByPatientId = /*#__PURE__*/function () {
  ...
  return function deleteBookingByPatientId(_x27) {
